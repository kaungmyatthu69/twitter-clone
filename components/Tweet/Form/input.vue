<template>
  <div>
    ...
    <div class="p-4 pl-16">
      ...
      <input type="file" ref="imageInput" hidden @change="handleImageChange"
    ...
    <div class="flex p-2 pl-14 ">
      ...
      <div class="flex w-full text-white">
        <div @click="handleImageIconClick"
      ...
      <div>
        <UIButton size="sm" :disabled="isDisabled" @onClick="handleClick">
          <strong>
            Tweet
          </strong>
        </UIButton>
        <!--      <button @click="handleClick">Tweet</button>-->
